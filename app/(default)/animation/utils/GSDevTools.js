...
!(function (e, t) {
  ...
  function Draggable(g, p) {
    ...
    function Ai(e) {
            ...
            j &&
              ((l = t._gsMaxScrollY - t.scrollTop) < 0
                ...
                ? ((te = !0),
                  (s = Math.min(
                    l,
                    (d * (1 - Math.max(0, n.bottom - r) / ie)) | 0
                  )))
                : r < n.top + oe &&
                  t.scrollTop &&
                  ((te = !0),
      ...
      if (P) {
        ...
        G
          ...
          : W
          ? (j && ((q.deltaY = u - parseFloat(le.y)), (le.y = u + "px")),
          ...
          !f ||
            ...
            (!(H = !0) === Qa(q, "drag", "onDrag") &&
              (U && (q.x -= q.deltaX), j && (q.y -= q.deltaY), Ai(!0)),
            (H = !1));
      }
      P = !1;
    }
    ...
    function Ci(a, s, l, o) {
      return (
        ...
        Z(a)
          ...
          : Xe(a)
          ? function (e) {
              for (var t, o, n = a.length, i = 0, r = Ne; -1 < --n; )
                (o = (t = a[n]) - e) < 0 && (o = -o),
                  o < r && s <= t && t <= l && ((i = n), (r = o));
              return a[i];
            }
            ...
            ? (X = (function buildPointSnapFunc(l, s, c, d, p, u, g) {
                return (
                  ...
                  Z(l)
                    ...
                    ? function (e) {
                        for (
                          var t, o, n, i, r = l.length, a = 0, s = Ne;
                          -1 < --r;
    ...
    function Ji() {
      ...
      W &&
        ...
        k &&
          n &&
          (S < T ? (T = S + (T - S) / n) : T < D && (T = D - (D - T) / n),
          G ||
            (A < M ? (M = A + (M - A) / n) : M < E && (M = E - (E - M) / n))),
        (q.startX = T = da(T)),
        (q.startY = M = da(M));
    }
    function Li() {
          ...
          G
            ...
            : (B &&
              ...
              (q.lockAxis || q.lockedAxis) &&
                ...
                ((l = q.lockedAxis) ||
                  ((q.lockedAxis = l =
                    U && Math.abs(n) > Math.abs(i) ? "y" : j ? "x" : null),
                  l &&
                    Z(q.vars.onLockAxis) &&
    ...
    return (
          ...
          if (
            ...
            for (
              ...
              (a = (s = Ge(r.parentNode)) ? We : r.parentNode),
                ...
                (r = a);
          q.isThrowing &&
            (i || q.endX > S || q.endX < D || q.endY > A || q.endY < E) &&
      ...
      (e.enable = function (e) {
        ...
        return (
          ...
          De &&
            "soft" !== e &&
            De.track(h || g, W ? "x,y" : G ? "rotation" : "top,left"),
          (g._gsDragID = t = "d" + Ie++),
          (He[t] = q),
      ...
      (e.disable = function (e) {
        ...
        return (
          ...
          De &&
            "soft" !== e &&
            (De.untrack(h || g, W ? "x,y" : G ? "rotation" : "top,left"),
            q.tween && q.tween.kill()),
          h && h.disable(),
          xa(Ai),
  ...
  function Lb(e, t, o) {
    ...
    return (
      ...
      "svg" === e &&
        (n.setAttribute("xmlns", de), n.setAttribute("xmlns:xlink", pe)),
      o && (n.style.cssText = o),
      n
    );
  }
    ...
    Ze = function GSDevTools(r) {
      ...
      function rp(e) {
        ...
        o && (Wb(z, o, X, o + "x"), v.timeScale(o)),
          100 ===
            (S =
              ("inTime" in r ? Qb(r.inTime, i, 0, 0) : n ? t._inProgress : 0) ||
              0) &&
            !r.animation &&
            t &&
        ...
        B = V.create(x, {
          ...
          onDrag: function onDrag() {
            ...
            e < 0 ? (e = 0) : e > v._dur && (e = v._dur),
              f || v.time(e),
              (y.style.width =
                Math.min(D - S, Math.max(0, (e / v._dur) * 100 - S)) + "%"),
