...
export default function Header() {
  ...
  const [isBenchmarksDropdownOpen, setIsBenchmarksDropdownOpen] =
    useState(false);
  ...
  return (
    <header
      className="hidden sm:block fixed top-2 md:top-6 z-30 px-4 sm:px-6 w-[calc(100vw-2rem)]"
    ...
    >
      <div className="px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div
            className={`flex justify-between items-center h-14 border border-transparent rounded-lg px-3 transition-all duration-300 ${
              !top && "bg-white border-zinc-200 shadow-lg"
            }`}
          >
            <div className="flex items-center shrink-0 mr-4">
              <Link
                className="flex items-center justify-center bg-white w-8 h-8 rounded shadow shadow-zinc-950/20 mr-3"
                href="/"
              >
            ...
            <div className="hidden md:flex space-x-6 items-center">
              ...
              <Link
                href="/animation"
                className="text-sm font-medium text-zinc-600 hover:text-neutral-50"
              >
                Animation
              </Link>
            </div>
